...
// $Source: /usr/local/cvs/OpenSees/SRC/material/uniaxial/SelfCenteringRub.h,v $

#ifndef SelfCenteringRub_h
#define SelfCenteringRub_h

// Written: JAE
// Created: Oct 2007
//
// Description: This file contains the class definition for 
// Self-Centering Material.  SelfCenteringRub provides 
...
class SelfCenteringRub : public UniaxialMaterial
{
  public:
    SelfCenteringRub(int tag, double k1, double k2, double k3,
		      double ActF, double beta, double SlipDef, 
			  double BearDef, double rBear);
    SelfCenteringRub();
    ~SelfCenteringRub();

    const char *getClassType(void) const {return "SelfCenteringRub";};
  ...
  private:
    ...
    double k3;      // Stiffness of down line
